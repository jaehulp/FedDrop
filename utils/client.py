...
class Client(object):
    ...
    def __init__(self, args, model, idx: int, output_dir, datapath):
    ...
    def load_train_data(self):
        ...
        return torch.utils.data.DataLoader(train_data, self.batch_size, shuffle=True)
...
class ClientAvg(Client):
    ...
    def __init__(self, args, model, idx: int, output_dir, datapath):
        super().__init__(args, model, idx, output_dir, datapath)
