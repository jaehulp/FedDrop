...
for i in [10, 50, 100, 150, 200, 250]:
    ...
    cov_list = measure_client_raw_cov(epoch, model_dir, data_dir, model_dict, model_list, idx_list)
    ...
    plt.colorbar()
    plt.title('Correlation of each model feature')
    plt.tight_layout()
    plt.savefig(f'./graph_img/CorrFeature_epoch{epoch}_ResNet18.png', dpi=300)
    plt.clf()